...
const VoucherBanner: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      // Format: 2D 05:30:00 or 05:30:00
  ...
  if (!bestVoucher || !isVisible) return null;
    ...
    <div className="bg-neutral-900 text-white border-b border-white/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-center gap-3 md:gap-6 relative z-10 text-center md:text-left">
        ...
        <div className="flex items-center gap-2">
          ...
          {copied && (
            <span className="text-[10px] text-green-500 font-bold uppercase tracking-widest absolute -bottom-2 md:static md:bottom-auto">
              Copied!
            </span>
          )}
        </div>
